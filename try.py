...
class Terrain(object):
    def __init__(self):
        ...
        self.w.setGeometry(0, 100, 800, 600) # (xPos, yPos, width, height)
        self.w.show()
        ...
        # perlin noise object
        self.tmp = OpenSimplex() # we use OpenSimplex noise which avoids visually-significant directional artifacts characteristic of Perlin noise
        ...
        # create the mesh item from vertices, and set face colors
